...
The menu collapses in a sandwich icon from medium media queries.
...
The home page is designed to show each post as a Traditional Post Card; wich contains fields to show information about the post. Features for writting a mesage from the card and export as PDF were hidden because are not functional yet.
